...
public static class QueryExtensions {
  ...
  public static async Task<IEnumerable<dynamic>> GetAsync(this Query query, IDbTransaction? transaction = null, int? timeout = null, CancellationToken cancellationToken = default) {
    return await query.GetAsync<dynamic>(transaction, timeout, cancellationToken);
  }
  ...
  public static dynamic FirstOrDefault(this Query query, IDbTransaction? transaction = null, int? timeout = null) {
    return query.FirstOrDefault<dynamic>(transaction, timeout);
  }
  ...
  public static async Task<dynamic> FirstOrDefaultAsync(this Query query, IDbTransaction? transaction = null, int? timeout = null, CancellationToken cancellationToken = default) {
    return await query.FirstOrDefaultAsync<dynamic>(transaction, timeout, cancellationToken);
  }
  ...
  public static dynamic First(this Query query, IDbTransaction? transaction = null, int? timeout = null) {
    return query.First<dynamic>(transaction, timeout);
  }
  ...
  public static async Task<dynamic> FirstAsync(this Query query, IDbTransaction? transaction = null, int? timeout = null, CancellationToken cancellationToken = default) {
    return await query.FirstAsync<dynamic>(transaction, timeout, cancellationToken);
  }

  public static PaginationResult<T> Paginate<T>(this Query query, int skip, int perPage = 25, IDbTransaction? transaction = null, int? timeout = null) {
    var db = CreateQueryFactory(query);
    return db.Paginate<T>(query, skip, perPage, transaction, timeout);
  }

  public static async Task<PaginationResult<T>> PaginateAsync<T>(this Query query, int skip, int perPage = 25, IDbTransaction? transaction = null, int? timeout = null, CancellationToken cancellationToken = default) {
    var db = CreateQueryFactory(query);
    return await db.PaginateAsync<T>(query, skip, perPage, transaction, timeout, cancellationToken);
  }

  public static PaginationResult<dynamic> Paginate(this Query query, int skip, int perPage = 25, IDbTransaction? transaction = null, int? timeout = null) {
    return query.Paginate<dynamic>(skip, perPage, transaction, timeout);
  }

  public static async Task<PaginationResult<dynamic>> PaginateAsync(this Query query, int skip, int perPage = 25, IDbTransaction? transaction = null, int? timeout = null, CancellationToken cancellationToken = default) {
    return await query.PaginateAsync<dynamic>(skip, perPage, transaction, timeout, cancellationToken);
  }
  ...
  //  await query.ChunkAsync<dynamic>(chunkSize, func, transaction, timeout, cancellationToken);
  //}
  ...
  //  await query.ChunkAsync<dynamic>(chunkSize, action, transaction, timeout, cancellationToken);
  //}
