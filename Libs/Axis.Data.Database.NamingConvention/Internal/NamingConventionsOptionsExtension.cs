...
public class NamingConventionsOptionsExtension : IDbContextOptionsExtension {
  ...
  public virtual string Name {
    get => _namingConvention.ToString();
  }
  ...
  public virtual NamingConventionsOptionsExtension WithSnakeCaseNamingConvention(CultureInfo culture = default!) {
    var clone = Clone();
  ...
  public virtual NamingConventionsOptionsExtension WithLowerCaseNamingConvention(CultureInfo culture = default!) {
    var clone = Clone();
  ...
  public virtual NamingConventionsOptionsExtension WithUpperCaseNamingConvention(CultureInfo culture = default!) {
    var clone = Clone();
  ...
  public virtual NamingConventionsOptionsExtension WithUpperSnakeCaseNamingConvention(CultureInfo culture = default!) {
    var clone = Clone();
  ...
  public virtual NamingConventionsOptionsExtension WithCamelCaseNamingConvention(CultureInfo culture = default!) {
    var clone = Clone();
